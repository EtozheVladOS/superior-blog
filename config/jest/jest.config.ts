...
export default {
  ...
  // cacheDirectory: "/private/var/folders/4j/rwc6fxf55gb7syp_9hm02wwr0000gn/T/jest_dx",
  ...
  // maxWorkers: 10% will use 10% of your
  ...
  // An array of regexp pattern strings, matched
  // against all module paths before considered 'visible' to the module loader
  ...
  // matched against all modules before the module loader will automatically return a mock for them
